...
public class FSCS_ART_real_v2 {
	...
	main m=new main();
	public FSCS_ART_real_v2(ArrayList<Dimension> dim_list,int f_k,String name) {
		/*
		 * 求输入域面积，这是共存在步骤
		 */
...
//		return false;
	...
	public static void main(String args[]) {
		...
		int k=5;//k从2到10
		f_k=10-k;
		double failrate=0.001817;
		String name="tanh";
		
		
		Dimension x = new Dimension(-500, 500);
//		Dimension y = new Dimension(0.001, 300);
//		Dimension z = new Dimension(0.001, 10000);
//		Dimension u = new Dimension(0.001, 1000);
//		Dimension z = new Dimension(-15, 15);
//		Dimension u = new Dimension(-15, 15);
...
//		list.add(d);
		...
		for (int i = 1; i <= times; i++) {
			...
			temp=new FSCS_ART_real_v2(list,f_k,name).run();
